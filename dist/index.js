...
/******/ 	var hotCurrentHash = "4b024962ac6516fdda13";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StoreEvent = _interopRequire(__webpack_require__(6));

	var AppDispatcher = _interopRequire(__webpack_require__(5));
	...
	var Store = (function () {
	    function Store() {
	        ...
	        this.dispatcherIndex = AppDispatcher.register((function (payload) {
	            ...
	            var eventContainer = _this.events[type];

	            if (typeof eventContainer !== "undefined") {
	                var executed = eventContainer.dispatch(action);
	    ...
	    _createClass(Store, {
	        subscribe: {
	            value: function subscribe(eventFunc, setupFunc) {
	                var _this = this;

	                // Setup events
	                setupFunc((function (eventName) {
	                    var eventSetting = _this.events[eventName];

	                    if (typeof eventSetting === "undefined") {
	                        eventSetting = _this.events[eventName] = new StoreEvent();
	                    }
